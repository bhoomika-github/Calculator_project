...
class Calculator:
    def __init__(self, master):
        master.title("BHOOMI's Calculator")
        ...
        Button(width=11, height=4, text='8', relief='flat', bg='Gray', command=lambda: self.show(8)).place(x=90, y=275)
        Button(width=11, height=4, text='9', relief='flat', bg='Gray', command=lambda: self.show(9)).place(x=180, y=275)
